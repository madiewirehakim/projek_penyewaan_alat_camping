...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">Penyewaan Alat Camping</a>
                ...
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            ...
                            <br>
                        <li class="nav-item">
                            <a class="nav-link" href="kembalian_barang.php">
                    ...
                    <ul class="nav flex-column mb-2">
                        <li class="nav-item">
                            <a class="nav-link" href="penyewaan_barang.php">
                                <span data-feather="file-text"></span>
                                Penyewaan Barang
                            </a>
                        </li>
                        <br>
                        <li class="nav-item">
                            <a class="nav-link" href="Transaksi_sewa.php">
                                <span data-feather="file-text"></span>
                                Transaksi Sewa
                            </a>
                        </li>
